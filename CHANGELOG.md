...
- The remote UI now exchanges its administrator key for a short-lived session, keeps masters out of browser storage and WebSocket URLs, and uses one-use WebSocket tickets. (#1525)
